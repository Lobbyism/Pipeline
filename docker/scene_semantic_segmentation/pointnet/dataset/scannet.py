...
class Dataset():
    ...
    def __init__(self, npoints, split, use_color, box_size, path, dropout_max):
        ...
        self.split = split
        self.num_classes = 21
        self.labels_names = ['unannotated', 'human', 'chair', 'floor', 'table', 'desk', 'bed',
        ...
        with open(self.data_filename,'rb') as fp:
            ...
            self.filenames = pickle.load(fp) #Added.
    ...
    def __getitem__(self, index, visu=False):
        ...
        sample_weight *= mask
        return index, point_set, point_set, semantic_seg, np.zeros_like(point_set), sample_weight
