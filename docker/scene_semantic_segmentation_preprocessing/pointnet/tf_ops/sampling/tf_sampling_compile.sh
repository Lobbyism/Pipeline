#TF="/mnt/c/Users/ordic/pointnet2/venv/lib/python2.7/site-packages/tensorflow"
TF="/usr/local/lib/python2.7/dist-packages/tensorflow"
...
# TF1.2
#g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I "$TF/include" -I /usr/local/cuda-8.0/include -lcudart -L /usr/local/cuda-8.0/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I "$TF/include" -I /usr/local/cuda-11.0/include -lcudart -L /usr/local/cuda-11.0/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0
